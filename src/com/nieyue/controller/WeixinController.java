...
public class WeixinController {
	...
	public @ResponseBody String connectionWeiXin(@RequestParam("url")String url,HttpSession session){
		String json = WeiXinBusiness.WXJSSDK(ThirdParty.GetValueByKey(ThirdParty.WEIXIN_BENZHENCHAHUA_APPID), ThirdParty.GetValueByKey(ThirdParty.WEIXIN_BENZHENCHAHUA_SECRET), url);
		//雅耀的公众号
